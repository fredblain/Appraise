...
usage: export_meteval_results.py

Exports METEVAL results for all language pairs, in CSV WMT format.
...
if __name__ == "__main__":
    ...
    from appraise.meteval.models import RankingResult, Project
