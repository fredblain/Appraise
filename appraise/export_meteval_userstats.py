...
usage: export_meteval_userstats.py
...
if __name__ == "__main__":
    ...
    from appraise.meteval.views import _identify_groups_for_user

    # Compute user statistics for all users.
    user_stats = []
    meteval = Group.objects.get(name='METEVAL')
    users = meteval.user_set.all()
