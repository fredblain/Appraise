...
from appraise.meteval.validators import validate_hit_xml, validate_segment_xml
...
LOGGER = logging.getLogger('appraise.meteval.models')
...
class HIT(models.Model):
    """
    HIT object model for meteval ranking evaluation.
    ...
    def get_absolute_url(self):
        ...
        """
        hit_handler_view = 'appraise.meteval.views.hit_handler'
    ...
    def get_status_url(self):
        ...
        """
        status_handler_view = 'appraise.meteval.views.status_view'
        kwargs = {'hit_id': self.hit_id}
    ...
    def export_to_xml(self):
        ...
        """
        template = get_template('meteval/task_result.xml')
...
class RankingTask(models.Model):
    """
    RankingTask object model for meteval ranking evaluation.
    """
...
class RankingResult(models.Model):
    ...
    def export_to_ranking_xml(self):
        ...
        """
        template = get_template('meteval/ranking_result.xml')
...
def update_user_hit_mappings(sender, instance, created, **kwargs):
    ...
    if len(results) > 2:
        from appraise.meteval.views import _compute_next_task_for_user
...
def initialize_database():
    """
    Initializes database with required language code and METEVAL groups
    """
    ...
    LOGGER.debug("Validating group 'METEVAL'")
    _ = Group.objects.get_or_create(name='METEVAL')
