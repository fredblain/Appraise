...
if __name__ == "__main__":
    ...
    from appraise.meteval.models import HIT, Project
    from appraise.meteval.validators import validate_hits_xml_file
        ...
        for _child in _tree:
            ...
            try:
                ...
                if args.dry_run_enabled:
                    ...
                    # them for METEVAL to measure intra-annotator agreement...
